...
(function(){
    ...
    else if(s(b)&&ia(b))for(d in b)a.setAttribute(d,b[d]);return e
    }
    function la(a){
    return Va(a)?a:[a]
    }
    ...
    var b=a,c=c===void 0?e.decimalPoint:c,d=d===void 0?e.thousandsSep:d,e=f<0?"-":"",a=String(F(f=W(+f||0).toFixed(b))),g=a.length>3?a.length%3:0;
    ...
    function Cb(a,b){
    var c=b||[[fb,[1,2,5,10,20,25,50,100,200,500]],[Za,[1,2,5,10,15,30]],[La,[1,2,5,10,15,30]],[sa,[1,2,3,4,6,8,12]],[fa,[1,2]],[Aa,
    [1,2]],[Ba,[1,2,3,4,6]],[na,null]],d=c[c.length-1],e=E[d[0]],f=d[1],g;
    for(g=0;g<c.length;g++)if(d=c[g],e=E[d[0]],f=d[1],c[g+1]&&a<=(e*f[f.length-1]+E[c[g+1][0]])/2)break;e===E[na]&&a<5*e&&(f=[1,2,5]);
...
function gb(a,b,c,d){
    var e=[],f={},g=T.global.useUTC,h,k=new Date(b),b=a.unitRange,i=a.count;
    ...
    if(b)throw c;else Y.console&&console.log(c)
        }
        function pa(a){
    ...
    function Ib(){
    var a=T.global.useUTC,b=a?"getUTC":"get",c=a?"setUTC":"set";
    ...
    function wb(a,b){
    var c=b.borderWidth,d=b.style,e=b.shared,f=F(d.padding);
    this.chart=a;
    this.options=b;
    d.padding=0;
    this.crosshairs=[];
    ...
    c=y(T,a);
    c.series=a.series=d;
    var d=c.chart,e=d.margin,e=ia(e)?e:[e,e,e,e];
    ...
    var v,I=document,Y=window,R=Math,u=R.round,$=R.floor,Ga=R.ceil,t=R.max,O=R.min,W=R.abs,ga=R.cos,ka=R.sin,Ha=R.PI,
Nb=Ha*2/360,Ia=navigator.userAgent,Xa=/msie/i.test(Ia)&&!Y.opera,Oa=I.documentMode===8,Ob=/AppleWebKit/.test(Ia),Pb=/Firefox/.test(Ia),Pa=!!I.createElementNS&&!!I.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect,bc=Pb&&parseInt(Ia.split("Firefox/")[1],10)<4,ma=!Pa&&!Xa&&!!I.createElement("canvas").getContext,Qa,aa=I.documentElement.ontouchstart!==v,Qb={},yb=0,kb,T,ua,$a,db,E,Rb=function(){},oa="div",da="none",zb="rgba(192,192,192,"+(Pa?1.0E-6:0.0020)+")",fb="millisecond",Za="second",
    La="minute",sa="hour",fa="day",Aa="week",Ba="month",na="year",jb,qb,rb,tb,Ca,hb,ib,Db,Eb,sb,Fb,Gb,U={};
    
    Y.Highcharts={};
    
    ua=function(a,b,c){
        if(!s(b)||isNaN(b))return"Invalid date";
        var a=p(a,"%Y-%m-%d %H:%M:%S"),d=new Date(b),e,f=d[rb](),g=d[tb](),h=d[Ca](),k=d[hb](),i=d[ib](),j=T.lang,l=j.weekdays,b={
            a:l[g].substr(0,3),
            A:l[g],
            d:za(h),
            e:h,
...
db={
    init:function(a,b,c){
        var b=b||"",d=a.shift,e=b.indexOf("C")>-1,f=e?7:3,g,b=b.split(" "),c=[].concat(c),h,k,i=function(a){
            for(g=a.length;g--;)a[g]==="M"&&a.splice(g+1,0,a[g+1],a[g+2],a[g+1],a[g+
                2])
            };
...
var P=
Y.HighchartsAdapter,L=P||{},eb=L.adapterRun,Sb=L.getScript,n=L.each,Ab=L.grep,Tb=L.offset,va=L.map,y=L.merge,B=L.addEvent,Q=L.removeEvent,N=L.fireEvent,Ub=L.washMouseEvent,lb=L.animate,Ra=L.stop;
P&&P.init&&P.init(db);
if(!P&&Y.jQuery){
    var ba=jQuery,Sb=ba.getScript,eb=function(a,b){
        return ba(a)[b]()
        },n=function(a,b){
        for(var c=0,d=a.length;c<d;c++)if(b.call(a[c],a[c],c,a)===!1)return c
            },Ab=ba.grep,va=function(a,b){
...
Fa.prototype={
    init:function(a,b){
        ...
        I.createElementNS("http://www.w3.org/2000/svg",b);
        this.renderer=a;
        this.attrSetters={}
    },
...
attr:function(a,b){
    var c,d,e,f,g=this.element,h=g.nodeName,k=this.renderer,i,j=this.attrSetters,l=this.shadows,m,o,r=this;
    ...
    [c]||c:c==="strokeWidth"&&(c="stroke-width"),r=G(g,c)||this[c]||0,c!=="d"&&c!=="visibility"&&(r=parseFloat(r));
    else for(c in a)if(i=!1,d=a[c],e=j[c]&&j[c](d,c),e!==!1){
        e!==v&&(d=e);
        ...
        [c]||c;
            ...
            "translateX"||c==="translateY"||c==="rotation"||c==="verticalAlign")i=o=!0;
        else if(c==="stroke")d=k.color(d,g,c);
        else if(c==="dashstyle")if(c="stroke-dasharray",d=d&&d.toLowerCase(),d==="solid")d=da;
            else{
            if(d){
    ...
    [d];
        ...
        l.length;e--;)G(l[e],c,c==="height"?t(d-(l[e].cutHeight||0),0):d);
...
crisp:function(a,b,c,d,e){
    var f,g={},h={},k,a=a||this.strokeWidth||this.attr&&this.attr("stroke-width")||0;
    k=u(a)%2/2;
    h.x=$(b||this.x||0)+k;
    h.y=$(c||this.y||0)+k;
...
htmlUpdateTransform:function(){
    if(this.added){
        ...
        if(b.tagName==="SPAN"){
            var j,l,i=this.rotation,m;
            j=0;
            var o=1,r=0,A;
            m=F(this.textWidth);
            var q=this.xCorr||0,C=this.yCorr||0,J=[i,g,b.innerHTML,this.textWidth].join(",");
            if(J!==this.cTT)s(i)&&(j=i*Nb,o=ga(j),r=ka(j),M(b,{
                ...
                display:"block",
                whiteSpace:"normal"
            }),j=m),m=a.fontMetrics(b.style.fontSize).b,
                q=o<0&&-j,C=r<0&&-l,A=o*r<0,q+=r*m*(A?1-h:h),C-=o*m*(i?A?h:1-h:1),k&&(q-=j*h*(o<0?-1:1),i&&(C-=l*h*(r<0?-1:1)),M(b,{
                    textAlign:g
...
updateTransform:function(){
    ...
    c?e.push("rotate(90) scale(-1,1)"):d&&e.push("rotate("+d+" "+(this.x||0)+
        " "+(this.y||0)+")");
...
getBBox:function(a){
    ...
    c=b.height;
    if(d)b.width=
        W(c*ka(e))+W(a*ga(e)),b.height=W(c*ga(e))+W(a*ka(e))
...
add:function(a){
    ...
    if(c.handleZ)for(c=0;c<e.length;c++)if(a=e[c],b=G(a,"zIndex"),a!==f&&(F(b)>g||!s(g)&&s(b))){
        d.insertBefore(f,
            a);
        h=!0;
        break
...
qa.prototype={
    ...
    buildText:function(a){
        ...
        c[c.length-1]===""&&c.pop();
        n(c,function(c,d){
            var h,A=0,q,c=c.replace(/<span/g,"|||<span").replace(/<\/span>/g,"</span>|||");
            h=c.split("|||");
            n(h,function(c){
                if(c!==""||h.length===1){
                    var m={},n=I.createElementNS("http://www.w3.org/2000/svg","tspan");
                    ...
                    if(!A){
                        if(d){
                            ...
                            if(!q||isNaN(q)){
                                var p;
                                if(!(p=i))if(!(p=j.offsetHeight))l[d]=b.getBBox().height,p=u(l[d]-(l[d-1]||0))||18;
                                q=p
                                }
                                G(n,"dy",q)
                            }
                    ...
                    b.appendChild(n);
                    A++;
                    if(k)for(var c=c.replace(/-/g,"- ").split(" "),D=[];c.length||D.length;)p=a.getBBox().width,m=p>k,!m||c.length===1?(c=D,D=[],
                        c.length&&(n=I.createElementNS("http://www.w3.org/2000/svg","tspan"),G(n,{
                            dy:i||16,
                            x:g
...
button:function(a,b,c,d,e,f,g){
    var h=this.label(a,b,c),k=0,i,j,l,m,o,a={
        x1:0,
        y1:0,
        x2:0,
        y2:1
    },e=y(ha("stroke-width",1,"stroke","#999","fill",ha("linearGradient",a,"stops",[[0,"#FFF"],[1,"#DDD"]]),"r",3,"padding",3,"style",ha("color","black")),e);
    l=e.style;
    delete e.style;
    f=y(e,ha("stroke","#68A","fill",ha("linearGradient",a,"stops",[[0,"#FFF"],[1,"#ACF"]])),f);
    m=f.style;
    delete f.style;
    g=y(e,ha("stroke","#68A","fill",ha("linearGradient",a,"stops",[[0,"#9BD"],[1,"#CDF"]])),g);
    o=g.style;
    delete g.style;
...
symbol:function(a,b,c,d,e,f){
    var g,h=this.symbols[a],h=h&&h(u(b),u(c),d,e,f),k=/^url\((.*?)\)$/,i,j;
    h?(g=this.path(h),z(g,{
        symbolName:a,
        x:b,
        y:c,
...
symbols:{
    ...
    arc:function(a,b,c,d,e){
        var f=e.start,c=e.r||c||d,g=e.end-1.0E-6,d=e.innerR,h=e.open,k=ga(f),i=ka(f),j=ga(g),g=ka(g),e=e.end-f<Ha?0:1;
...
color:function(a,b,c){
    ...
    if(g){
        var c=a[g],h=d.gradients,k,i,j,b=b.radialReference;
        if(!c.id||!h[c.id])Va(c)&&(a[g]=c={
            ...
            f.test(a[1])?(e=wa(a[1]),i=e.get("rgb"),
                j=e.get("a")):(i=a[1],j=1);
...
html:function(a,b,c){
    var d=T.chart.style,e=this.createElement("span"),f=e.attrSetters,g=e.element,h=e.renderer;
    f.text=function(a){
        g.innerHTML=a;
        return!1
        };
...
fontMetrics:function(a){
    var a=F(a||11),a=a<24?a+4:u(a*1.2),b=u(a*0.8);
    return{
        h:a,
        b:b
    }
...
label:function(a,b,c,d,e,f,g,h,k){
    function i(){
        var a=o.styles,a=a&&a.textAlign,b=J*(1-
            p),c;
        c=h?0:Sa;
        ...
        var m=this,o=m.g(k),r=m.text("",0,0,g).attr({
        zIndex:1
    }).add(o),A,q,p=0,J=3,w,x,D,K,H=0,t={},Sa,g=o.attrSetters;
    B(o,"add",l);
    g.width=function(a){
        w=a;
        return!1
...
if(!Pa&&!ma){
    ...
    toggleChildren:function(a,b){
        ...
        "DIV"&&this.toggleChildren(c[d],b)
            },
    updateTransform:Fa.prototype.htmlUpdateTransform,
    attr:function(a,b){
        var c,d,e,f=this.element||{},g=f.style,h=f.nodeName,k=this.renderer,i=this.symbolName,j,l=this.shadows,m,o=this.attrSetters,r=this;
        ya(a)&&s(b)&&(c=a,a={},a[c]=b);
        if(ya(a))c=a,r=c==="strokeWidth"||c==="stroke-width"?this.strokeweight:this[c];else for(c in a)if(d=a[c],m=!1,e=o[c]&&o[c](d,c),e!==!1&&d!==null){
            e!==v&&(d=e);
            if(i&&/^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))j||(this.symbolAttr(a),
                j=!0),m=!0;
            else if(c==="d"){
                d=d||[];
                this.d=d.join(" ");
                ...
                d&&(g[c]=d);
                m=!0
                }else if(c==="width"||c==="height")d=t(0,d),this[c]=d,this.updateClipping?(this[c]=d,this.updateClipping()):g[c]=
                d,m=!0;
    ...
    shadow:function(a,b,
        c){
        var d=[],e=this.element,f=this.renderer,g,h=e.style,k,i=e.path,j,l;
        ...
        if(a){
            for(a=1;a<=3;a++){
                ...
                b?b.element.appendChild(g):e.parentNode.insertBefore(g,
                    e);
                d.push(g)
                }
                this.shadows=d
    ...
    clipRect:function(a,b,c,d){
        ...
        return z(e,{
            ...
            height:d,
            getCSS:function(a){
                var b=a.inverted,c=this.top,d=this.left,e=d+this.width,j=c+this.height,c={
...
color:function(a,b,c){
    ...
    if(f){
        var h,k,i=a.linearGradient||a.radialGradient,j,l,m,o,r,A,q="",a=a.stops,p,J=[];
        l=a[0];
        p=a[a.length-1];
        ...
        f==="gradient"?(j=i.x1||i[0]||0,a=i.y1||i[1]||0,l=i.x2||i[2]||0,i=i.y2||i[3]||0,j=90-R.atan((i-a)/(l-j))*180/Ha):(g=i.r*2,
            q='src="http://code.highcharts.com/gfx/radial-gradient.png" size="'+g+","+g+'" origin="0.5,0.5" position="'+i.cx+","+i.cy+'" color2="'+A+'" ',g=r);
...
symbols:{
    arc:function(a,b,c,d,e){
        var f=e.start,g=e.end,h=e.r||c||d,c=ga(f),d=ka(f),k=ga(g),i=ka(g),j=e.innerR,l=0.08/h,m=j&&0.1/j||0;
        if(g-f===0)return["x"];else 2*Ha-g+f<l?k=-l:g-f<m&&(k=ga(f+m));
...
ab.prototype={
    addLabel:function(){
        var a=this.axis,b=a.options,c=a.chart,d=a.horiz,e=a.categories,f=this.pos,g=b.labels,h=a.tickPositions,d=e&&d&&e.length&&!g.step&&!g.staggerLines&&!g.rotation&&c.plotWidth/h.length||!d&&c.plotWidth/2,k=f===h[0],i=f===h[h.length-1],j=e&&s(e[f])?e[f]:f,e=this.label,h=h.info,l;
...
getLabelSize:function(){
    ...
    return a?(this.labelBBox=a.getBBox(!0))[b.horiz?"height":
    "width"]:0
    },
...
handleOverflow:function(a,b){
    var c=!0,d=this.axis,e=d.chart,f=this.isFirst,g=this.isLast,h=b.x,k=d.reversed,i=d.tickPositions;
    if(f||g){
        var j=this.getLabelSides(),l=j[0],j=j[1],e=e.plotLeft,m=e+d.len,i=(d=d.ticks[i[a+(f?1:-1)]])&&d.label.xy.x+d.getLabelSides()[f?0:1];
...
getLabelPosition:function(a,b,c,d,e,f,g,h){
    var k=this.axis,i=k.transA,j=k.reversed,k=k.staggerLines,a=a+e.x-(f&&d?f*i*(j?-1:1):0),b=b+e.y-(f&&!d?f*i*(j?1:-1):0);
    s(e.y)||(b+=F(c.styles.lineHeight)*
        0.9-c.getBBox().height/2);
    k&&(b+=g/(h||1)%k*16);
    return{
        x:a,
        y:b
...
render:function(a,b){
    var c=this.axis,d=c.options,e=c.chart.renderer,f=c.horiz,g=this.type,h=this.label,k=this.pos,i=d.labels,j=this.gridLine,l=g?g+"Grid":"grid",m=g?g+"Tick":"tick",o=d[l+"LineWidth"],r=d[l+"LineColor"],A=d[l+"LineDashStyle"],q=d[m+"Length"],l=d[m+"Width"]||0,n=d[m+"Color"],J=d[m+"Position"],m=this.mark,w=i.step,x=!0,D=d.categories&&
    d.tickmarkPlacement==="between"?0.5:0,K=this.getPosition(f,k,D,b),H=K.x,K=K.y,s=c.staggerLines;
    if(o){
    ...
    if(h&&!isNaN(H))h.xy=
        K=this.getLabelPosition(H,K,h,f,i,D,a,w),this.isFirst&&!p(d.showFirstLabel,1)||this.isLast&&!p(d.showLastLabel,1)?x=!1:!s&&f&&i.overflow==="justify"&&!this.handleOverflow(a,K)&&(x=!1),w&&a%w&&(x=!1),x?(h[this.isNew?"attr":"animate"](K),h.show(),this.isNew=!1):h.hide()
        },
destroy:function(){
    ta(this,this.axis)
    }
...
vb.prototype={
    render:function(){
        var a=this,b=a.axis,c=b.horiz,d=(b.pointRange||0)/2,e=a.options,f=e.label,g=a.label,h=e.width,k=e.to,i=e.from,j=s(i)&&s(k),l=e.value,m=e.dashStyle,o=a.svgElem,
        r=[],A,q=e.color,n=e.zIndex,J=e.events,w=b.chart.renderer;
        ...
        else if(r&&r.length&&(a.svgElem=o=w.path(r).attr(d).add(),J))for(A in e=
            function(b){
                o.on(b,function(c){
                    J[b].apply(a,[c])
                    })
                },J)e(A);if(f&&s(f.text)&&r&&r.length&&b.width>0&&b.height>0){
            f=y({
                align:c&&j&&"center",
                x:c?!j&&4:10,
...
Jb.prototype={
    ...
    setOffset:function(a,b){
        var c=this.axis,d=c.chart,e=d.inverted,f=this.isNegative,g=c.translate(this.total,
            0,0,0,1),c=c.translate(0),c=W(g-c),h=d.xAxis[0].translate(this.x)+a,d=d.plotHeight,e={
            x:e?f?g:g-c:h,
...
init:function(a,b){
    ...
    for(g in d)B(this,
        g,d[g]);if(this.isLog)this.val2lin=ra,this.lin2val=ja
        },
...
getSeriesExtremes:function(){
    var a=
    this,b=a.chart,c=a.stacks,d=[],e=[],f;
    a.dataMin=a.dataMax=null;
    n(a.series,function(g){
        if(g.visible||!b.options.chart.ignoreHiddenSeries){
            var h=g.options,k,i,j,l,m,o,r,n,q,C=h.threshold,J,w=[],x=0;
            if(a.isLog&&C<=0)C=h.threshold=null;
            if(a.isXAxis){
                if(h=g.xData,h.length)a.dataMin=O(p(a.dataMin,h[0]),Ma(h)),a.dataMax=t(p(a.dataMax,h[0]),Da(h))
                    }else{
                var D,K,H,u=g.cropped,Sa=g.xAxis.getExtremes(),y=!!g.modifyValue;
                k=h.stacking;
                a.usePercentage=k==="percent";
                if(k)m=h.stack,l=g.type+p(m,""),o="-"+l,g.stackKey=
                    l,i=d[l]||[],d[l]=i,j=e[o]||[],e[o]=j;
                ...
                for(f=0;f<J;f++)if(n=h[f],q=r[f],q!==null&&q!==v&&(k?(K=(D=q<C)?j:i,H=D?o:l,q=K[n]=s(K[n])?K[n]+q:q,c[H]||(c[H]={}),c[H][n]||(c[H][n]=new Jb(a,a.options.stackLabels,D,n,m)),c[H][n].setTotal(q)):y&&(q=g.modifyValue(q)),u||(h[f+1]||n)>=Sa.min&&(h[f-1]||n)<=Sa.max))if(n=q.length)for(;n--;)q[n]!==null&&(w[x++]=q[n]);else w[x++]=q;if(!a.usePercentage&&w.length)a.dataMin=O(p(a.dataMin,
                    w[0]),Ma(w)),a.dataMax=t(p(a.dataMax,w[0]),Da(w));
                if(s(C))if(a.dataMin>=C)a.dataMin=C,a.ignoreMinPadding=!0;
...
translate:function(a,b,c,d,e){
    var f=this.len,g=1,h=0,k=d?this.oldTransA:this.transA,d=d?this.oldMin:this.min,e=this.options.ordinal||this.isLog&&e;
    if(!k)k=this.transA;
    c&&(g*=-1,h=f);
...
getPlotLinePath:function(a,b,c){
    var d=this.chart,e=this.left,f=this.top,g,h,k,a=this.translate(a,null,null,c),i=c&&d.oldChartHeight||d.chartHeight,j=c&&d.oldChartWidth||d.chartWidth,l;
    g=this.transB;
    c=h=u(a+g);
    g=k=u(i-a-g);
    if(isNaN(a))l=!0;
...
getLogTickPositions:function(a,b,c,d){
    ...
    else if(a>=0.08)for(var f=$(b),h,k,i,j,l,e=a>0.3?[1,2,4]:a>0.15?[1,2,4,6,8]:[1,2,3,4,5,6,7,8,9];f<c+1&&!l;f++){
        k=e.length;
        for(h=0;h<k&&!l;h++)i=ra(ja(f)*
            e[h]),i>b&&g.push(j),j>c&&(l=!0),j=i
...
getMinorTickPositions:function(){
    ...
    if(this.isLog){
        e=a.length;
        for(d=
            1;d<e;d++)c=c.concat(this.getLogTickPositions(b,a[d-1],a[d],!0))
            }else for(a=this.min+(a[0]-this.min)%b;a<=this.max;a+=b)c.push(a);
    return c
    },
adjustForMinRange:function(){
    var a=this.options,b=this.min,c=this.max,d,e=this.dataMax-this.dataMin>=this.minRange,f,g,h,k,i;
    if(this.isXAxis&&this.minRange===v&&!this.isLog)s(a.min)||s(a.max)?this.minRange=null:(n(this.series,function(a){
        k=a.xData;
        for(g=i=a.xIncrement?1:k.length-1;g>0;g--)if(h=k[g]-k[g-1],f===v||h<f)f=h
...
setAxisTranslation:function(){
    ...
    if(this.isXAxis)this.isLinked?b=this.linkedParent.pointRange:n(this.series,function(a){
        ...
        }),this.pointRange=b,this.closestPointRange=
    c;
    this.oldTransA=e;
...
setTickPositions:function(a){
    var b=this,c=b.chart,d=b.options,e=b.isLog,f=b.isDatetimeAxis,g=b.isXAxis,h=b.isLinked,k=b.options.tickPositioner,i=d.maxPadding,j=d.minPadding,l=d.tickInterval,m=d.tickPixelInterval,o=b.categories;
    h?(b.linkedParent=c[g?"xAxis":"yAxis"][d.linkedTo],c=b.linkedParent.getExtremes(),b.min=p(c.min,c.dataMin),b.max=p(c.max,c.dataMax),
        d.type!==b.linkedParent.options.type&&ub(11,1)):(b.min=p(b.userMin,d.min,b.dataMin),b.max=p(b.userMax,d.max,b.dataMax));
    ...
    if(!o&&!b.usePercentage&&!h&&s(b.min)&&s(b.max)){
        ...
        if(!s(d.max)&&!s(b.userMax)&&i&&(b.dataMax>
            0||!b.ignoreMaxPadding))b.max+=c*i
            }
    ...
    if(!f&&!e&&(a=R.pow(10,$(R.log(b.tickInterval)/
        R.LN10)),!s(d.tickInterval)))b.tickInterval=pb(b.tickInterval,null,a,d);
    ...
    if(!h)e=
        k[0],f=k[k.length-1],d.startOnTick?b.min=e:b.min>e&&k.shift(),d.endOnTick?b.max=f:b.max<f&&k.pop()
        },
...
setScale:function(){
    ...
    if(e||d||this.isLinked||this.userMin!==this.oldUserMin||
        this.userMax!==this.oldUserMax)if(this.getSeriesExtremes(),this.setTickPositions(),this.oldUserMin=this.userMin,this.oldUserMax=this.userMax,!this.isDirty)this.isDirty=e||this.min!==this.oldMin||this.max!==this.oldMax;
    if(!this.isXAxis)for(b in a)for(c in a[b])a[b][c].cum=a[b][c].total;this.setMaxTicks()
    },
setExtremes:function(a,b,c,d,e){
    var f=this,g=f.chart,c=p(c,!0),e=z(e,{
        min:a,
        max:b
    });
...
setAxisSize:function(){
    var a=
    this.chart,b=this.options,c=b.offsetLeft||0,d=b.offsetRight||0;
...
getOffset:function(){
    var a=this,b=a.chart,c=b.renderer,d=a.options,e=a.tickPositions,f=a.ticks,g=a.horiz,h=a.side,k,i=0,j,l=0,m=d.title,o=d.labels,r=0,A=b.axisOffset,q=[-1,1,1,-1][h],C;
    a.hasData=b=a.series.length&&s(a.min)&&
    s(a.max);
    ...
    if(b||a.isLinked)n(e,function(b){
        ...
        [h]===o.align)r=t(f[a].getLabelSize(),r)
            }),a.staggerLines&&(r+=(a.staggerLines-1)*16);else for(C in f)f[C].destroy(),delete f[C];if(m&&m.text){
...
getLinePath:function(a){
    var b=this.chart,c=this.opposite,d=this.offset,e=this.horiz,f=this.left+(c?this.width:
        0)+d,c=b.chartHeight-this.bottom-(c?this.height:0)+d;
...
getTitlePosition:function(){
    var a=this.horiz,b=this.left,c=this.top,d=this.len,e=this.options.title,f=a?b:c,g=this.opposite,h=this.offset,k=F(e.style.fontSize||12),d={
        low:f+(a?0:d),
        middle:f+d/2,
        high:f+(a?d:0)
        }
    ...
    return{
        x:a?d:b+(g?this.width:
            0)+h+(e.x||0),
        y:a?b-(g?this.height:0)+h:d+(e.y||0)
        }
    },
render:function(){
    var a=this,b=a.chart,c=b.renderer,d=a.options,e=a.isLog,f=a.isLinked,g=a.tickPositions,h=a.axisTitle,k=a.stacks,i=a.ticks,j=a.minorTicks,l=a.alternateBands,m=d.stackLabels,o=d.alternateGridColor,r=d.lineWidth,p,q=b.hasRendered&&s(a.oldMin)&&!isNaN(a.oldMin),C=a.showAxis,J,w;
    if(a.hasData||f)if(a.minorTickInterval&&!a.categories&&n(a.getMinorTickPositions(),function(b){
        j[b]||(j[b]=new ab(a,b,"minor"));
        q&&j[b].isNew&&j[b].render(null,
            !0);
        j[b].isActive=!0;
        j[b].render()
    ...
    if(m&&m.enabled){
        ...
        for(x in k)for(D in b=k[x],b)b[D].render(d)
            }
            a.isDirty=!1
    },
...
getAnchor:function(a,b){
    var c,d=this.chart,e=d.inverted,f=0,g=0,a=la(a);
    c=a[0].tooltipPos;
    c||(n(a,function(a){
        f+=a.plotX;
...
getPosition:function(a,b,c){
    var d=this.chart,e=d.plotLeft,f=d.plotTop,g=d.plotWidth,h=d.plotHeight,k=p(this.options.distance,12),i=c.plotX,c=c.plotY,d=i+e+(d.inverted?k:-a-k),
    j=c-b+f+15,l;
    d<7&&(d=e+i+k);
...
refresh:function(a,b){
    function c(){
        ...
        var d=this.chart,e=this.label,f=this.options,g,h,k,
    i={},j,l=[];
    j=f.formatter||c;
    var i=d.hoverPoints,m,o=f.crosshairs;
    k=this.shared;
    ...
    if(o){
        o=la(o);
        for(e=o.length;e--;)if(k=a.series[e?"yAxis":"xAxis"],o[e]&&k)if(k=k.getPlotLinePath(e?p(a.stackY,a.y):a.x,1),this.crosshairs[e])this.crosshairs[e].attr({
            d:k,
            visibility:"visible"
        });
        else{
...
Kb.prototype={
    ...
    onmousemove:function(a){
        var b=this.chart,c=b.series,d,e,f=b.hoverPoint,g=b.hoverSeries,h,k,i=b.chartWidth,j=b.inverted?b.plotHeight+b.plotTop-a.chartY:a.chartX-b.plotLeft;
        if(b.tooltip&&this.options.tooltip.shared&&(!g||!g.noSharedTooltip)){
            e=
            [];
            h=c.length;
            for(k=0;k<h;k++)if(c[k].visible&&c[k].options.enableMouseTracking!==!1&&!c[k].noSharedTooltip&&c[k].tooltipPoints.length)d=c[k].tooltipPoints[j],d._dist=W(j-d.plotX),i=O(i,d._dist),e.push(d);for(h=e.length;h--;)e[h]._dist>i&&e.splice(h,1);
...
b.hideTooltipOnMouseMove=function(a){
    Ub(a);
    b.chartPosition&&c.hoverSeries&&c.hoverSeries.isCartesian&&!c.isInsidePlot(a.pageX-
        b.chartPosition.left-c.plotLeft,a.pageY-b.chartPosition.top-c.plotTop)&&b.resetTracker()
    };
...
var h=function(a){
    if(!a||!(a.touches&&a.touches.length>1)){
        ...
        var d=a.chartX,
        h=a.chartY,l=!c.isInsidePlot(d-c.plotLeft,h-c.plotTop);
        ...
        if(c.mouseIsDown&&a.type!=="touchstart"){
            if(e=Math.sqrt(Math.pow(b.mouseDownX-d,2)+Math.pow(b.mouseDownY-h,2)),e>10){
                a=c.isInsidePlot(b.mouseDownX-c.plotLeft,
...
d.onclick=function(a){
    ...
    a.cancelBubble=!0;
    if(!c.cancelClick)d&&(G(a.target,"isTracker")||G(a.target.parentNode,"isTracker"))?
        (e=d.plotX,f=d.plotY,z(d,{
...
xb.prototype={
    init:function(a){
        ...
        if(c.enabled){
            var d=c.itemStyle,e=p(c.padding,8),f=c.itemMarginTop||
            0;
...
renderItem:function(a){
    var x;
    var b=this,c=b.chart,d=c.renderer,e=b.options,f=e.layout==="horizontal",g=e.symbolWidth,h=e.symbolPadding,k=b.itemStyle,i=b.itemHiddenStyle,j=b.padding,l=!e.rtl,m=e.width,o=e.itemMarginBottom||0,r=b.itemMarginTop,n=b.initialItemX,q=a.legendItem,p=a.series||a,s=p.options,w=s.showCheckbox;
    if(!q&&(a.legendGroup=d.g("legend-item").attr({
        zIndex:1
    }).add(b.scrollGroup),
        p.drawLegendSymbol(b,a),a.legendItem=q=d.text(e.labelFormatter.call(a),l?g+h:-h,b.baseline,e.useHTML).css(y(a.visible?k:i)).attr({
            align:l?"left":"right",
            zIndex:2
            ...
            a.visible),s&&w))a.checkbox=V("input",{
        type:"checkbox",
        checked:a.selected,
...
render:function(){
    var a=this,b=a.chart,c=b.renderer,d=a.group,e,f,g,h,k=a.box,i=a.options,j=a.padding,l=i.borderWidth,m=i.backgroundColor;
    ...
    if(l||m){
        ...
        h+=j;
        if(k){
            if(g>0&&h>0)k[k.isNew?
                "attr":"animate"](k.crisp(null,null,null,g,h)),k.isNew=!1
...
handleOverflow:function(a){
    var b=this,c=this.chart,d=c.renderer,e=this.options,f=e.y,f=c.spacingBox.height+(e.verticalAlign===
        "top"?-f:f)-this.padding,g=e.maxHeight,h=this.clipRect,k=e.navigation,i=p(k.animation,!0),j=k.arrowSize||12,l=this.nav;
    ...
    if(a>f){
        ...
        if(!l)this.nav=l=d.g().attr({
            ...
            b.scroll(-1,i)
            }).add(l),this.pager=d.text("",15,10).css(k.style).add(l),this.down=d.symbol("triangle-down",
            0,0,j,j).on("click",function(){
            b.scroll(1,i)
            }).add(l);
        b.scroll(0);
        a=f
...
scroll:function(a,b){
    var c=this.pageCount,d=this.currentPage+a,e=this.clipHeight,f=this.options.navigation,g=f.activeColor,f=f.inactiveColor,h=this.pager,k=this.padding;
    d>c&&(d=c);
...
cb.prototype={
    initSeries:function(a){
        var b=this.options.chart,b=new U[a.type||b.type||b.defaultSeriesType];
        b.init(this,a);
        return b
        },
    ...
    redraw:function(a){
        var b=this.axes,c=this.series,d=this.tracker,e=this.legend,f=this.isDirtyLegend,g,h=this.isDirtyBox,k=c.length,i=k,j=this.clipRect,l=this.renderer,m=l.isHidden();
        Ea(a,this);
        for(m&&this.cloneRenderTo();i--;)if(a=c[i],a.isDirty&&a.options.stacking){
            g=
            !0;
            break
        }
        if(g)for(i=k;i--;)if(a=c[i],a.options.stacking)a.isDirty=!0;n(c,function(a){
    ...
    showLoading:function(a){
        ...
        this.loadingSpan=V("span",null,d.labelStyle,c);
...
get:function(a){
    ...
    for(d=0;d<c.length;d++)if(c[d].options.id===a)return c[d];for(d=0;d<c.length;d++){
        e=c[d].points||[];
...
showResetZoom:function(){
    var a=this,b=T.lang,c=a.options.chart.resetZoomButton,d=c.theme,e=d.states,f=c.relativeTo==="chart"?null:{
        x:a.plotLeft,
        y:a.plotTop,
        width:a.plotWidth,
        height:a.plotHeight
...
getMargins:function(){
    var a=this.options.chart,b=a.spacingTop,c=a.spacingRight,d=
    a.spacingBottom,a=a.spacingLeft,e,f=this.legend,g=this.optionsMarginTop,h=this.optionsMarginLeft,k=this.optionsMarginRight,i=this.optionsMarginBottom,j=this.chartTitleOptions,l=this.chartSubtitleOptions,m=this.options.legend,o=p(m.margin,10),r=m.x,A=m.y,q=m.align,C=m.verticalAlign;
    this.resetMargins();
    e=this.axisOffset;
    if((this.title||this.subtitle)&&!s(this.optionsMarginTop))if(l=t(this.title&&!j.floating&&!j.verticalAlign&&j.y||0,this.subtitle&&!l.floating&&!l.verticalAlign&&l.y||0))this.plotTop=
        t(this.plotTop,l+p(j.margin,15)+b);
...
initReflow:function(){
    function a(a){
        var g=c.width||eb(d,"width"),h=c.height||eb(d,"height"),a=a?a.target:Y;
        if(g&&h&&(a===Y||a===I)){
...
setChartSize:function(){
    var a=this.inverted,b=this.chartWidth,c=this.chartHeight,
    d=this.options.chart,e=d.spacingTop,f=d.spacingRight,g=d.spacingBottom,d=d.spacingLeft;
...
resetMargins:function(){
    ...
    b=a.spacingRight,c=a.spacingBottom,d=a.spacingLeft;
...
drawChartBox:function(){
    var a=this.options.chart,b=this.renderer,c=this.chartWidth,d=this.chartHeight,e=this.chartBackground,f=this.plotBackground,g=this.plotBorder,h=this.plotBGImage,k=a.borderWidth||0,i=a.backgroundColor,j=a.plotBackgroundColor,
    l=a.plotBackgroundImage,m,o={
        x:this.plotLeft,
        y:this.plotTop,
    ...
    m=k+(a.shadow?8:0);
    if(k||i)if(e)e.animate(e.crisp(null,null,null,c-m,d-m));
        else{
        e={
            fill:i||da
            };
    ...
    if(l)h?h.animate(o):
        this.plotBGImage=b.image(l,this.plotLeft,this.plotTop,this.plotWidth,this.plotHeight).add();
...
render:function(){
    ...
    e.items&&n(e.items,function(){
        var b=z(e.style,this.style),d=F(b.left)+a.plotLeft,f=F(b.top)+a.plotTop+12;
        delete b.left;
        delete b.top;
...
init:function(a){
    ...
    if(a)for(c in a)B(this,c,a[c]);this.xAxis=[];
    this.yAxis=[];
    this.animation=ma?!1:p(b.animation,
        !0);
...
tooltipFormatter:function(a){
    var b=this.series,c=b.tooltipOptions,d=a.match(/\{(series|point)\.[a-zA-Z]+\}/g),e=/[{\.}]/,f,g,h,k,i={
        y:0,
        open:0,
        high:0,
        low:0,
    ...
    [h[1]],h=h[2],f===this&&i.hasOwnProperty(h)?(f=i[h]?h:"value",f=(c[f+
        "Prefix"]||"")+Ya(this[h],p(c[f+"Decimals"],-1))+(c[f+"Suffix"]||"")):f=f[h],a=a.replace(g,f));return a
    },
update:function(a,b,c){
    var d=this,e=d.series,f=d.graphic,g,h=e.data,k=h.length,i=e.chart,b=p(b,!0);
...
remove:function(a,b){
    ...
    e=d.chart,f,g=d.data,h=g.length;
    Ea(b,e);
    a=p(a,!0);
...
importEvents:function(){
    if(!this.hasImportedEvents){
        ...
        this.events=a;
        for(b in a)B(this,b,a[b]);this.hasImportedEvents=!0
        }
    },
setState:function(a){
    var b=this.plotX,c=this.plotY,d=this.series,e=d.options.states,f=S[d.type].marker&&d.options.marker,g=f&&!f.enabled,h=f&&f.states[a],k=h&&h.enabled===!1,i=d.stateMarkerGraphic,j=d.chart,l=this.pointAttr,a=a||"";
    if(!(a===this.state||this.selected&&a!=="select"||e[a]&&e[a].enabled===
        !1||a&&(k||g&&!h.enabled))){
...
Z.prototype={
    ...
    init:function(a,b){
        ...
        if(ma)b.animation=!1;
        d=b.events;
        for(c in d)B(this,c,d[c]);if(d&&d.click||b.point&&b.point.events&&b.point.events.click||b.allowPointSelect)a.runTrackerClick=!0;
        this.getColor();
        this.getSymbol();
    ...
    addPoint:function(a,b,c,d){
        var e=this.data,f=this.graph,g=this.area,h=this.chart,k=this.xData,i=this.yData,j=f&&f.shift||0,l=this.options.data;
        Ea(d,h);
        if(f&&c)f.shift=j+1;
        if(g){
            if(c)g.shift=j+1;
        ...
        l.push(a);
        c&&(e[0]&&e[0].remove?
            e[0].remove(!1):(e.shift(),k.shift(),i.shift(),l.shift()));
        this.getAttribs();
        this.isDirtyData=this.isDirty=!0;
        b&&h.redraw()
        },
    setData:function(a,b){
        var c=this.points,d=this.options,e=this.initialColor,f=this.chart,g=null,h=this.xAxis,k=this.pointClass.prototype;
        this.xIncrement=null;
        this.pointRange=h&&h.categories&&1||d.pointRange;
        if(s(e))f.counters.color=e;
        var i=[],j=[],l=a?a.length:[],m=this.valueCount;
        if(l>(d.turboThreshold||1E3)){
            ...
            if(Wa(g)){
                ...
                this.xIncrement=k
                }else if(Va(g))if(m)for(e=0;e<l;e++)d=a[e],i[e]=d[0],j[e]=d.slice(1,m+1);else for(e=0;e<l;e++)d=a[e],i[e]=d[0],j[e]=d[1]
                }else for(e=0;e<l;e++)d={
            series:this
    ...
    processData:function(a){
        var b=this.xData,c=this.yData,d=b.length,e=0,f=d,g,h,k=this.xAxis,i=this.options,j=i.cropThreshold,l=this.isCartesian;
        if(l&&!this.isDirty&&!k.isDirty&&!this.yAxis.isDirty&&!a)return!1;
        if(l&&this.sorted&&(!j||d>j||this.forceCrop))if(a=k.getExtremes(),k=a.min,j=
            a.max,b[d-1]<k||b[0]>j)b=[],c=[];
            else if(b[0]<k||b[d-1]>j){
            for(a=0;a<d;a++)if(b[a]>=k){
                e=t(0,a-1);
                break
            }
            for(;a<d;a++)if(b[a]>j){
            ...
            for(a=b.length-1;a>0;a--)if(d=b[a]-b[a-1],d>0&&(h===v||d<h))h=d;this.cropped=g;
        this.cropStart=e;
    ...
    generatePoints:function(){
        ...
        g=d.length,h=this.cropStart||0,k,i=this.hasGroupedData,j,l=[],m;
        ...
        if(b&&(g!==(c=b.length)||i))for(m=0;m<c;m++)if(m===h&&!i&&(m+=g),b[m])b[m].destroyElements(),b[m].plotX=v;this.data=b;
        this.points=l
        },
    translate:function(){
        this.processedXData||this.processData();
        this.generatePoints();
        for(var a=this.chart,b=this.options,
            c=b.stacking,d=this.xAxis,e=d.categories,f=this.yAxis,g=this.points,h=g.length,k=!!this.modifyValue,i,j=f.series,l=j.length;l--;)if(j[l].visible){
            l===this.index&&(i=!0);
            break
        }
        for(l=0;l<h;l++){
            var j=g[l],m=j.x,o=j.y,r=j.low,n=f.stacks[(o<b.threshold?"-":"")+this.stackKey];
...
tooltipHeaderFormatter:function(a){
    ...
    if(e&&!c)for(f in E)if(E[f]>=d.closestPointRange){
...
drawPoints:function(){
    var a,b=this.points,c=this.chart,d,e,f,g,h,k,i,j;
    if(this.options.marker.enabled)for(f=b.length;f--;)if(g=b[f],d=g.plotX,e=g.plotY,j=g.graphic,e!==v&&!isNaN(e))if(a=g.pointAttr[g.selected?"select":""],h=a.r,k=p(g.marker&&g.marker.symbol,this.symbol),i=k.indexOf("url")===0,j)j.animate(z({
        x:d-h,
        y:e-h
        },j.symbolName?{
        width:2*h,
...
getAttribs:function(){
    var a=this,b=S[a.type].marker?a.options.marker:a.options,c=b.states,d=c.hover,e,f=a.color,g={
        stroke:f,
        fill:f
    },h=a.points||[],k=[],i,j=a.pointAttrToOptions,l;
    ...
    for(f=h.length;f--;){
        ...
        e=!1;
        if(g.options)for(l in j)s(b[j[l]])&&(e=!0);if(e){
            i=[];
            c=b.states||{};
            ...
            i.select=a.convertAttribs(c.select,k.select,
                i[""])
            }else i=k;
        g.pointAttr=i
        }
...
destroy:function(){
    var a=this,b=a.chart,c=a.clipRect,d=/AppleWebKit\/533/.test(Ia),e,f,g=a.data||[],h,k,i;
    N(a,"destroy");
    Q(a);
...
drawDataLabels:function(){
    ...
    if(c.enabled||a._hasPointLabels){
        var d,e,f=a.points,g,h,k,i=a.dataLabelsGroup,j=a.chart,l=a.xAxis,l=l?l.left:j.plotLeft,m=a.yAxis,m=m?m.top:j.plotTop,o=j.renderer,r=j.inverted,A=a.type,q=b.stacking,C=A==="column"||A==="bar",J=c.verticalAlign===null,w=c.y===null,x=o.fontMetrics(c.style.fontSize),D=x.h,K=x.b,H,t;
        C&&(x={
            top:K,
            middle:K-D/2,
            bottom:-D+
        ...
        n(f,function(f){
            ...
            if(t=c.enabled){
                var l=f.barX&&f.barX+f.barW/2||p(f.plotX,-999),m=p(f.plotY,-999),n=c.y===null?f.y>=b.threshold?-D+K:K:c.y;
                d=(r?j.plotWidth-
                    m:l)+c.x;
                ...
                if(H)H.attr({
                    ...
                    for(w in l)l[w]===v&&delete l[w];H=f.dataLabel=o[c.rotation?"text":"label"](k,d,e,null,null,null,c.useHTML,!0).attr(l).css(c.style).add(i).shadow(c.shadow)
                    }
...
getSegmentPath:function(a){
    var b=this,c=[];
    n(a,function(d,e){
        b.getPointSpline?c.push.apply(c,b.getPointSpline(a,d,e)):(c.push(e?"L":"M"),e&&b.options.step&&c.push(d.plotX,a[e-1].plotY),c.push(d.plotX,
            d.plotY))
        });
    return c
    },
drawGraph:function(){
    var a=this,b=a.options,c=a.graph,d=[],e=a.group,f=b.lineColor||a.color,g=b.lineWidth,h=b.dashStyle,k,i=a.chart.renderer,j=[];
...
render:function(){
    var a=this,b=a.chart,c,d=a.options,e=d.clip!==!1,f=d.animation,f=(d=f&&a.animate)?
    f&&f.duration||500:0,g=a.clipRect,h=b.renderer;
...
setState:function(a){
    var b=this.options,c=this.graph,d=b.states,b=b.lineWidth,
    a=a||"";
...
setVisible:function(a,b){
    var c=this.chart,d=this.legendItem,e=this.group,f=this.tracker,g=this.dataLabelsGroup,h,k=this.points,i=c.options.chart.ignoreHiddenSeries;
    h=this.visible;
    h=(this.visible=a=a===v?!h:a)?"show":"hide";
    if(e)e[h]();
    if(f)f[h]();
    else if(k)for(e=k.length;e--;)if(f=k[e],f.tracker)f.tracker[h]();if(g)g[h]();
...
drawTracker:function(){
    var a=this,b=a.options,c=b.trackByArea,d=[].concat(c?a.areaPath:a.graphPath),e=d.length,f=a.chart,g=f.renderer,h=f.options.tooltip.snap,k=a.tracker,i=b.cursor,i=i&&{
        cursor:i
    },j=a.singlePoints,l=a.drawTrackerGroup(),m;
    if(e&&!c)for(m=e+1;m--;)d[m]==="M"&&d.splice(m+1,0,d[m+1]-h,d[m+2],"L"),(m&&d[m]==="M"||m===e)&&d.splice(m,0,"L",d[m-2]+h,d[m-1]);
    for(m=0;m<j.length;m++)e=j[m],d.push("M",e.plotX-h,e.plotY,
        "L",e.plotX+h,e.plotY);
    k?k.attr({
        d:d
...
ea=ca(Z,{
    ...
    getPointSpline:function(a,b,c){
        var d=b.plotX,e=b.plotY,f=a[c-1],g=a[c+1],h,k,i,j;
        if(c&&c<a.length-1){
            a=f.plotY;
            i=g.plotX;
            var g=g.plotY,l;
...
ea=ca(Z,{
    ...
    translate:function(){
        var a=this,b=a.chart,c=a.options,d=c.stacking,e=c.borderWidth,f=0,g=a.xAxis,h=g.reversed,k={},i,j;
        ...
        var l=a.points,g=W(g.transA)*(g.ordinalSlope||c.pointRange||g.closestPointRange||1),
        m=g*c.groupPadding,o=(g-2*m)/f,r=c.pointWidth,A=s(r)?(o-r)/2:o*c.pointPadding,q=p(r,o-2*A),C=Ga(t(q,1+2*e)),u=A+(m+((h?f-a.columnIndex:a.columnIndex)||0)*o-g/2)*(h?-1:1),w=a.yAxis.getThreshold(c.threshold),x=p(c.minPointLength,5);
        n(l,function(c){
            var f=c.plotY,g=p(c.yBottom,w),h=c.plotX+u,i=Ga(O(f,g)),k=Ga(t(f,g)-i),j=a.yAxis.stacks[(c.y<0?"-":"")+a.stackKey];
    ...
    drawPoints:function(){
        ...
        n(a.points,function(f){
            var g=f.plotY;
            if(g!==v&&!isNaN(g)&&f.y!==null)d=f.graphic,e=f.shapeArgs,d?(Ra(d),d.animate(y(e))):f.graphic=d=c[f.shapeType](e).attr(f.pointAttr[f.selected?
                "select":""]).add(a.group).shadow(b.shadow,null,b.stacking&&!b.borderRadius)
                })
        },
    drawTracker:function(){
        var a=this,b=a.chart,c=b.renderer,d,e,f=+new Date,g=a.options,h=g.cursor,k=h&&{
            cursor:h
        },i=a.drawTrackerGroup(),j,l,m;
...
drawTracker:function(){
    for(var a=this,b=a.options.cursor,b=b&&{
        cursor:b
    },c=a.points,d=c.length,e;d--;)if(e=c[d].graphic)e.element._i=d;a._hasTracking?a._hasTracking=!0:a.group.attr({
        isTracker:!0
...
translate:function(){
    this.generatePoints();
    var a=0,b=-0.25,c=this.options,d=c.slicedOffset,e=d+c.borderWidth,f,g=this.chart,h,k,i,j=this.points,l=2*Ha,m,o,r,p=c.dataLabels.distance;
    ...
    n(j,function(c){
        ...
        r+ka(i)*e,f[0]+o,f[1]+r,p<0?"center":i<l/4?"left":"right",i];
        c.percentage=m*100;
        c.total=a
        });
...
drawPoints:function(){
    var a=this,b=a.chart,c=b.renderer,d,e,f,g=a.options.shadow,h,k;
    n(a.points,function(i){
        e=i.graphic;
        k=i.shapeArgs;
        f=i.group;
        h=i.shadowGroup;
        if(g&&!h)h=i.shadowGroup=
            c.g("shadow").attr({
                zIndex:4
            }).add();
...
drawDataLabels:function(){
    var a=this.data,b,c=this.chart,d=this.options.dataLabels,e=p(d.connectorPadding,10),f=p(d.connectorWidth,
        1),g,h,k=p(d.softConnector,!0),i=d.distance,j=this.center,l=j[2]/2,m=j[1],o=i>0,r=[[],[]],A,q,C,s,w=2,x;
    if(d.enabled){
        ...
        for(a=r[0][0]&&r[0][0].dataLabel&&(r[0][0].dataLabel.getBBox().height||21);w--;){
            ...
            if(i>0){
                ...
                if(v>C){
                    ...
                    if(t<x&&D[x]!==null)t=x;else for(C<v-x+t&&D[x]!==null&&(t=C-v+x);D[t]===null;)t++;
                    u.push({
                        i:t,
                        y:D[t]
                        });
                ...
                A=d.justify?j[0]+(w?-1:1)*(l+i):this.getX(t===0||t===D.length-1?
                    A:q,w);
                g.attr({
                    visibility:C,
                    align:h[6]
...
P=ca(Z,P);
U.pie=P;
var X=Z.prototype,dc=X.processData,ec=X.generatePoints,fc=X.destroy,gc=X.tooltipHeaderFormatter,P={
    approximation:"average",
    groupPixelWidth:2,
    dateTimeLabelFormats:ha(fb,["%A, %b %e, %H:%M:%S.%L","%A, %b %e, %H:%M:%S.%L","-%H:%M:%S.%L"],Za,["%A, %b %e, %H:%M:%S","%A, %b %e, %H:%M:%S","-%H:%M:%S"],La,["%A, %b %e, %H:%M","%A, %b %e, %H:%M","-%H:%M"],sa,["%A, %b %e, %H:%M","%A, %b %e, %H:%M",
        "-%H:%M"],fa,["%A, %b %e, %Y","%A, %b %e","-%A, %b %e, %Y"],Aa,["Week from %A, %b %e, %Y","%A, %b %e","-%A, %b %e, %Y"],Ba,["%B %Y","%B","-%B %Y"],na,["%Y","%Y","-%Y"])
    },Yb=[[fb,[1,2,5,10,20,25,50,100,200,500]],[Za,[1,2,5,10,15,30]],[La,[1,2,5,10,15,30]],[sa,[1,2,3,4,6,8,12]],[fa,[1]],[Aa,[1]],[Ba,[1,3,6]],[na,null]],Ua={
    sum:function(a){
        var b=a.length,c;
...
X.groupData=function(a,b,c,d){
    ...
    i,j,l=!!b;
    j=[];
    var m=[],o=[],n=[],p=typeof d==="function"?d:Ua[d],q;
    for(q=0;q<=k;q++){
        for(;c[1]!==v&&a[q]>=c[1]||q===k;)if(i=c.shift(),j=p(j,m,o,n),j!==v&&(g.push(i),h.push(j)),j=[],m=[],o=[],n=[],q===k)break;if(q===k)break;
        i=l?b[q]:null;
        if(d==="ohlc"){
            i=this.cropStart+q;
            var t=e&&e[i]||this.pointClass.prototype.applyOptions.apply({},[f[i]]);
            i=t.open;
            var s=t.high,w=t.low,t=t.close;
            if(typeof i==="number")j.push(i);
            else if(i===null)j.hasNulls=!0;
            if(typeof s==="number")m.push(s);
            else if(s===null)m.hasNulls=
                !0;
...
X.processData=function(){
    var a=this.options,b=a.dataGrouping,c=b&&b.enabled,d;
    this.forceCrop=c;
    if(dc.apply(this,arguments)!==!1&&c){
        this.destroyGroupedData();
        var e;
        e=this.chart;
        var c=this.processedXData,f=this.processedYData,g=e.plotSizeX,h=this.xAxis,k=p(h.groupPixelWidth,b.groupPixelWidth),
        i=c.length,j=e.series,l=this.pointRange;
...
X.tooltipHeaderFormatter=function(a){
    ...
    if(f&&f.options.type==="datetime"&&c){
        ...
        else if(!d)for(h in E)if(E[h]>=f.closestPointRange){
            d=c[h][0];
            break
        }
        d=ua(d,a);
...
var P=ca(xa,{
    ...
    tooltipFormatter:function(){
        ...
        a.color+';font-weight:bold">',this.name||a.name,"</span><br/>Open: ",this.open,"<br/>High: ",this.high,"<br/>Low: ",this.low,"<br/>Close: ",this.close,"<br/>"].join("")
        },
    toYData:function(){
    ...
    drawPoints:function(){
        var a=this,b=a.chart,c,d,e,f,g,h,k,i;
...
P=ca(Bb,{
    ...
    getAttribs:function(){
        ...
        var a=this.options,b=a.states,a=a.upColor,c=y(this.pointAttr);
        c[""].fill=a;
    ...
    drawPoints:function(){
        var a=this,b=a.chart,c,d,e,f,g,h,k,i,j,l;
...
U.flags=ca(U.column,{
    ...
    translate:function(){
        U.column.prototype.translate.apply(this);
        var a=this.chart,b=this.points,c=b.length-1,d,e,f=this.options.onSeries,f=(d=f&&a.get(f))&&d.options.step,g=d&&d.points,h=g&&g.length,k=this.xAxis.getExtremes(),i,j,l;
        if(d&&d.visible&&h){
            j=g[h-1].x;
            for(b.sort(function(a,b){
                return a.x-b.x
                });h--&&b[c];)if(d=b[c],i=g[h],i.x<=d.x&&i.plotY!==v){
...
drawPoints:function(){
    var a,b=this.points,c=this.chart.renderer,d,e,f=this.options,g=f.y,h=f.shape,k,i,j,l,m=f.lineWidth%2/2,o;
    for(j=b.length;j--;)if(l=b[j],d=l.plotX+m,i=l.stackIndex,e=l.plotY,e!==v&&(e=l.plotY+g+m-(i!==v&&i*f.stackDistance)),k=i?v:l.plotX+m,o=i?v:l.plotY,i=l.graphic,a=l.tracker,e!==v)a=l.pointAttr[l.selected?"select":""],i?i.attr({
        x:d,
        y:e,
        r:a.r,
        anchorX:k,
...
var ob=aa?"touchstart":"mousedown",Zb=aa?"touchmove":"mousemove",$b=aa?"touchend":"mouseup",P=ha("linearGradient",
...
Lb.prototype={
    ...
    render:function(a,b,c,d){
        ...
        q=this.navigatorOptions,s=this.scrollbarOptions,v=this.height,w=this.top,x=this.navigatorEnabled,D=q.outlineWidth,K=D/2,H=this.outlineHeight,y=s.barBorderRadius,z=s.barBorderWidth,B=w+K;
        if(!isNaN(a)){
            ...
            if(m.getExtremes){
                var E=e.xAxis[0].getExtremes(),e=E.dataMin===null,G=m.getExtremes(),I=O(E.dataMin,G.dataMin),E=t(E.dataMax,G.dataMax);
                !e&&(I!==G.min||E!==G.max)&&
                m.setExtremes(I,E,!0,!1)
                }
                c=p(c,m.translate(a));
            d=p(d,m.translate(b));
...
init:function(){
    var a=this,b=a.chart,c,d,e=a.scrollbarHeight,f=a.navigatorOptions,g=a.height,h=a.top,k,i,j,l=document.body.style,m,o=a.baseSeries,n;
    a.mouseDownHandler=function(d){
        var d=b.tracker.normalizeMouseEvent(d),e=a.zoomedMin,f=a.zoomedMax,h=a.top,k=a.scrollbarHeight,j=a.scrollerLeft,o=a.scrollerWidth,
        n=a.navigatorLeft,p=a.navigatorWidth,r=a.range,q=d.chartX,s=d.chartY,d=aa?10:7;
    ...
    a.mouseMoveHandler=function(c){
        var d=
        a.scrollbarHeight,e=a.navigatorLeft,f=a.navigatorWidth,g=a.scrollerLeft,h=a.scrollerWidth,k=a.range,c=b.tracker.normalizeMouseEvent(c),c=c.chartX;
    ...
    a.mouseUpHandler=function(){
        ...
        a.grabbedLeft=
        a.grabbedRight=a.grabbedCenter=j=i=null;
        l.cursor=m
        };
        
    a.updatedDataHandler=function(){
        var c=o.xAxis,d=c.getExtremes(),e=d.min,f=d.max,g=d.dataMin,d=d.dataMax,h=f-e,i,j,l,m,q;
        i=k.xData;
        var p=!!c.setExtremes;
        j=f>=i[i.length-1];
        i=e<=g;
    ...
    if(a.navigatorEnabled){
        var v=o.options,w=v.data,u=f.series;
        n=u.data;
        v.data=u.data=null;
...
Mb.prototype={
    clickButton:function(a,b,c){
        var d=this,e=d.chart,f=d.buttons,g=e.xAxis[0],h=g&&g.getExtremes(),k=e.scroller&&e.scroller.xAxis,i=(k=k&&k.getExtremes&&k.getExtremes())&&k.dataMax,j=h&&h.dataMin,l=h&&h.dataMax,k=O(j,p(k&&k.dataMin,j)),i=t(l,p(i,l)),m,n=g&&O(h.max,i),h=new Date(n),l=b.type,j=b.count,r,s,q={
            millisecond:1,
            second:1E3,
            minute:6E4,
            hour:36E5,
    ...
    render:function(a,b){
        var c=this,
        d=c.chart,e=d.renderer,f=d.container,g=d.options.rangeSelector,h=c.buttons,k=T.lang,i=c.div,i=d.options.chart.style,j=g.buttonTheme,l=g.inputEnabled!==!1,m=j&&j.states,o=d.plotLeft,p;
    ...
    destroy:function(){
        var a=this.leftBox,
        b=this.rightBox,c=this.boxSpanElements,d=this.divRelative,e=this.divAbsolute,f=this.zoomText;
...
var hc=X.init,ic=X.processData,jc=xa.prototype.tooltipFormatter;
X.init=function(){
    hc.apply(this,arguments);
    var a=this.options.compare;
    if(a)this.modifyValue=
        function(b,c){
...
(function(){
    ...
    X.init=function(){
        ...
        if(d&&d.options.ordinal&&!d.hasOrdinalExtension){
            ...
            d.beforeSetTickPositions=function(){
                var a,b=[],c=!1,e,i=this.getExtremes(),j=i.min,i=i.max,l;
    ...
    d.lin2val=function(a,b){
        ...
        if(c){
            ...
            if(b)a<0?a=c[0]:a>j?a=c[j]:(j=$(a),m=a-j);else for(;j--;)if(l=d*j+e,a>=l){
                d=d*(j+1)+e;
                m=(a-l)/(d-l);
                break
            }
...
d.getNonLinearTimeTicks=function(a,b,c,e,i,j,l){
    var m=0,n=0,p,t={},q,u,y,w=[],x=d.options.tickPixelInterval;
...
b.pan=function(a){
    ...
    if(d.options.ordinal&&d.series.length){
        var k=b.mouseDownX,i=d.getExtremes(),j=i.dataMax,l=i.min,m=i.max,o;
        o=b.hoverPoints;
        var p=d.closestPointRange,k=(k-a)/(d.translationSlope*(d.ordinalSlope||p)),s={
            ordinalPositions:d.getExtendedPositions()
            },q,p=d.lin2val,u=d.val2lin;
        if(s.ordinalPositions){
            if(W(k)>1)o&&n(o,function(a){
                a.setState()
                }),k<0?(o=s,s=d.ordinalPositions?d:s):o=d.ordinalPositions?d:s,q=s.ordinalPositions,j>q[q.length-1]&&q.push(j),o=p.apply(o,[u.apply(o,[l,!0])+k,!0]),k=p.apply(s,[u.apply(s,
                [m,!0])+k,!0]),o>O(i.dataMin,l)&&k<t(j,m)&&d.setExtremes(o,k,!0,!1),b.mouseDownX=a,M(b.container,{
                cursor:"move"
            })
            }else h=!0
            }else h=!0;
